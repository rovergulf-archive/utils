# Go/Golang package for parsing user agent strings [![GoDoc](https://godoc.org/github.com/rovergulf/utils/useragent?status.svg)](https://godoc.org/github.com/rovergulf/utils/useragent)
